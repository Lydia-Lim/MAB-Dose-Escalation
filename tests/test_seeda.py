import numpy as np
import pytest
from doseescalation.dose_escalator import SEEDADoseEscalator
...
@pytest.mark.unit
def test_propose():
    dose_escalator = SEEDADoseEscalator((0, 1, 2),
                                        0.5,
                                        hyperbolic_tanh,
                                        (0.2, 0.4, 0.6),
                                        (0.2, 0.4, 0.6))
...
def test_propose_after_update():
    # Given
    dose_escalator = SEEDADoseEscalator(
